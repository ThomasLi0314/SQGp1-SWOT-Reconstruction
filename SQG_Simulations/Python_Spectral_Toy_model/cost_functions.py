...
def cost_function_fmin(phi0_s, kx, ky, mu, inv_mu, Bu, epsilon, K2, inv_K2, eta_s_hat_true):
    """
    ...
    eta_s_hat_guess = forward_ssh(phi0_s_hat_guess, kx, ky, mu, inv_mu, K2, inv_K2, Bu, epsilon)
