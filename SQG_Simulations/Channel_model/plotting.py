...
# ─────────────────────────────────────────────────────────
def prepare_surface_fields(phi0_s_opt, phi0_s_true, phi0_s_ori, u_qg, v_qg, x, y,
...
# ─────────────────────────────────────────────────────────
def plot_surface_fields(phi0_s_opt, phi0_s_true, phi0_s_ori, u_qg, v_qg, x, y,
                        kx, ky, mu, inv_mu, K2, inv_K2, epsilon, Bu,
                        Nx, Ny, elapsed, run_dir):
    """
    ...
    ctx = prepare_surface_fields(
        phi0_s_opt, phi0_s_true, phi0_s_ori, u_qg, v_qg, x, y,
        kx, ky, mu, inv_mu, K2, inv_K2, epsilon, Bu,
        Nx, Ny, elapsed, run_dir,
    )
